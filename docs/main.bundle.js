...
module.exports = "<h5><i class=\"fa fa-dollar\" aria-hidden=\"true\"></i> Cotizaciones <small>Consulte sus cotizaciones</small></h5>\n<div class=\"row\">\n  <div class=\"col-sm-12\">\n    <button (click)=\"nuevaCotizacion()\" class=\"btn btn-success float-right\"><i class=\"fa fa-file\" aria-hidden=\"true\"></i> Nueva cotizacion</button>\n  </div>\n</div>\n\n<div class=\"row\">\n  <div class=\"col-sm-12\" style=\"padding-top: 20px;\">\n    <table class=\"table table-hover\" *ngIf=\"cotizaciones.length > 0\">\n      <thead>\n        <tr>\n          <th>Cliente</th>\n          <th>Fecha</th>\n          <th></th>\n        </tr>\n      </thead>\n      <tbody>\n        <tr *ngFor=\"let cotizacion of cotizaciones\">\n          <td>{{cotizacion.customer.ruc}} - {{cotizacion.customer.name}}</td>\n          <td>11/03/2017</td>\n          <td><a [routerLink]=\"['/cotiza/detail/', cotizacion.id]\" class=\"btn btn-link btn-sm btn-outline-primary\"><i class=\"fa fa-search\" aria-hidden=\"true\"></i></a></td>\n        </tr>\n      </tbody>\n    </table>\n  </div>\n</div>\n"
